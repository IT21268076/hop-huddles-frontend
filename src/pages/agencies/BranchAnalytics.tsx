// pages/agencies/BranchAnalytics.tsx
...
export const BranchAnalytics: React.FC<BranchAnalyticsProps> = ({ branch }) => {
  const {
    data: analytics,
    loading,
  } = useAsync(
    async () => {
      ...
      return {
        ...
        averageProgress: 78,
        recentActivity: [
          { type: 'user_joined', message: 'John Doe joined the branch', timestamp: '2 hours ago' },
          { type: 'huddle_completed', message: 'Team Alpha completed Safety Training', timestamp: '4 hours ago' },
          { type: 'assessment_passed', message: 'Sarah Smith passed Clinical Assessment', timestamp: '1 day ago' },
        ]
      };
    },
    [branch.branchId]
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="p-4">
          ...
          <div className="mt-2">
            <Badge variant="success" size="sm">
              {analytics?.activeTeams || 0} active
            </Badge>
          </div>
        </Card>
